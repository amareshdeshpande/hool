...
public class GameTable {
	...
	@Column(name = "is_table_active")
	private int isTableActive;
...
*/
	...
	public int getIsTableActive() {
		return isTableActive;
	}

	public void setIsTableActive(int isTableActive) {
		this.isTableActive = isTableActive;
	}

	/*public List<GameTableMember>  getGameTableMember() {
		return gameTableMember;
	}

	public void setGameTableMember(List<GameTableMember>  gameTableMember) {
		this.gameTableMember = gameTableMember;
	}*/
}
